...
class Category(Base):
    ...
    products: Mapped[List["Product"]] = relationship(back_populates="category") # ORM связь с продуктами
...
class Product(Base):
    ...
    category: Mapped["Category"] = relationship(back_populates="products")  # ORM связь с категорией
